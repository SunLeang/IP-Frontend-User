  ...
  return (
    <Card className="overflow-hidden h-full">
      <div className="relative">
        ...
        />
        <Badge
          className={`absolute bottom-2 left-2 ${category.includes("Educational") ? "bg-blue-500" : "bg-orange-500"}`}
        >
          {category}
        </Badge>
        <button
      ...
      <CardContent className="p-4">
        <div className="flex gap-3">
          ...
          <div className="flex-1">
            <Link href={`/events/${id}`}>
              <h3 className="font-medium line-clamp-2 hover:text-blue-600 transition-colors">{title}</h3>
            </Link>
